  ...
  return (
    <>
      ...
      <div className="intro-container">
        <div className="row">
          <div
            className="col-xl-6 col-lg-6 col-12 text-center container-left"
            style={{}}
          >
            <div className="opacity-container px-4">
              <Link className="navbar-brand" to={"/"}>
                <img src={require("./../../images/bolo-64.png")} alt="" />
              </Link>
              <div className="mx-3">
                <h1>
                  Swaptoken With <strong className="text-primary">Swap</strong>.{" "}
                  <br /> Best price in the world
                </h1>
              ...
              <div className="intro-btn ">
                <ExternalLink href="https://app.swap.me">
                  <button className="btn  btn-primary mt-2 custom-btn-primary mx-3">
                    Swap Now
                  </button>
                </ExternalLink>
                <button
                  onClick={() =>
                    clipboard.copy("https://buy.swap.me/?ref=" + acct)
                  }
                  className="btn btn-outline-light mt-2 mx-3"
                >
                  {" "}
                  Copy Referal Link
                </button>
          ...
          <div className="col-xl-5 col-lg-5 col-11 mx-auto d-flex justify-content-center align-self-center">
            <div className="container-right ">
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="form-group">
                  <label className="mb-1 text-uppercase">Referal Account</label>
                  {/* <hr data-content="Referal Account" class="hr-text mr-sm-2 text-uppercase"/> */}
                  ...
                  <hr
                    data-content="Send"
                    class="hr-text mr-sm-2 text-uppercase"
                  />
                  {/* <label className="mr-sm-2 text-uppercase">Send</label> */}
                  <div className="input-group mb-3">
                    ...
                    <ul className="list-unstyled">
                      <li className="media">
                        ...
                        <div className="media-body">
                          <h5 className="m-0 text-uppercase">Get</h5>
                        </div>
                        <div className="text-right">
                          <h5>
                            {bolo ? parseFloat(bolo).toPrecision(4) : 0} SWAP
                          </h5>
                        </div>
                      </li>
                    </ul>
                  ...
                  <div className="intro-content">
                    ...
                    <Async promiseFn={getBalance}>
                      {({ data, error, isLoading }) => {
                        (() =>
                          isLoading
                            ? console.log("Async getBalance isLoading")
                            : null)();
                        if (data) {
                          return (
